...
namespace Maili
{
    public class Driver : Employee
    {
        ...
        public Driver(string firstName, string lastName, DateTime birth, string address, string email, string phone, int NSS, DateTime HiringDate, float Salary, bool Availability, int Order_nb = 0) 
